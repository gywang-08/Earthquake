...
public class PreferencesActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        updateFreqSpinner = findViewById(R.id.spinner_update_freq);//更新频率下拉框
        magnitudeSpinner = findViewById(R.id.spinner_quake_mag);//最小震级微调框
    ...
    private void updateUIFromPreferences(){
        ...
        boolean autoUpChange = prefs.getBoolean(PREF_AUTO_UPDATE,false);
        ...
        autoUpdate.setChecked(autoUpChange);
    }

    private void savePreferences(){
        int upadteIndex = updateFreqSpinner.getSelectedItemPosition();
        ...
        editor.putInt(PREF_UPDATE_FREQ_iNDEX,upadteIndex);
